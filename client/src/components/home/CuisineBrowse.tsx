        ...
        {cuisines.map((c) => {
          ...
          return (
            <button
              ...
              className="group cursor-pointer text-center py-8 bg-white border border-outline-variant/20 hover:border-secondary transition-colors duration-300 flex flex-col items-center justify-center"
            >
              <Icon
                size={32}
                strokeWidth={1.1}
                className="text-black/55 group-hover:text-secondary mb-4 transition-colors"
              />
