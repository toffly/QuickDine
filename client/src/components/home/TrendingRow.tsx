...
const TrendingRow = ({ trending, loading }: TrendingRowProps) => {
  return (
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        ...
        {loading ? (
          <div className="flex justify-center py-16">
            <div className="w-8 h-8 border-2 border-outline-variant/30 border-t-secondary rounded-full animate-spin" />
          </div>
        ) : (
